...
public class EventsController {
    ...
    public String generateThread(UserInput userInput, ModelMap map) {
        ...
        String template = """
				...
				The last tweet should include a call to action (e.g., learn more, register for the event). Include links and hashtags but do not include emoticons.
				{format}
				""";
...
//        Request generatedPosts = null;
    ...
    public String saveThread(UserInput userInput, ModelMap map)
    {
        try {
            ...
            map.addAttribute("errorMessage", "Failed to save!");
        }
        return "events";
    }
}